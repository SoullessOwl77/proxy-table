...
const SHELL = "pt-shell-v50";
const ART = "pt-art-v1";
const ART_LIMIT = 900;

const SHELL_FILES = ["./", "./index.html", "./wh40k.html", "./datasheet.html", "./army.html", "./howto.html", "./guide-data.js", "./datasheets/load.js", "./datasheets/index.js", "./datasheets/mfm-seed.js", "./datasheets/demo.js", "./datasheets/orks.js", "./datasheets/tyranids.js", "./datasheets/tyranids-pts.js", "./datasheets/space-marines.js", "./manifest.webmanifest", "./icon-192.png", "./icon-512.png"];
...
self.addEventListener("notificationclick", e => {
  ...
  if (d.type === "match" && d.matchId) {
    const g = d.game === "wh40k" ? "&game=wh40k" : (d.game ? "&game=" + encodeURIComponent(d.game) : "");
    url = `./index.html?match=${encodeURIComponent(d.matchId)}${g}`;

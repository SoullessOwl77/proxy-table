...
const SHELL = "pt-shell-v16";
const ART = "pt-art-v1";
const ART_LIMIT = 900;

const SHELL_FILES = ["./", "./index.html", "./wh40k.html", "./datasheet.html", "./army.html", "./datasheets/load.js", "./datasheets/index.js", "./datasheets/demo.js", "./datasheets/orks.js", "./manifest.webmanifest", "./icon-192.png", "./icon-512.png"];
